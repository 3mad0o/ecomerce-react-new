...
export const ProductCardEmpty = () => {
  return (
    <div className="bg-white flex flex-col overflow-hidden cursor-pointer hover:shadow-md transition-all z-1 animate-pulse">
      {/* Image skeleton */}
      <div className="w-full bg-gray-200 animate-pulse aspect-[230/230]"></div>
      ...
      <div className="p-2 flex-1 flex flex-col">
        ...
        <div className="flex items-center gap-2 mt-4">
          <div className="bg-gray-200 animate-pulse w-12 h-9 rounded"></div>
          <div className="bg-gray-200 animate-pulse h-9 w-full rounded"></div>
        </div>
      </div>
    </div>
  );
